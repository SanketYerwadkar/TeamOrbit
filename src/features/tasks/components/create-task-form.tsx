...
export const CreateTaskForm = ({ initialStatus, onCancel, memberOptions, projectOptions }: CreateTaskFormProps) => {
  ...
  return (
    <Card className="size-full border-none shadow-none bg-[#9FB3DF]">
      <CardHeader className="flex p-7 bg-white ">
      ...
      <CardContent className="p-7">
        <Form {...createTaskForm}>
          <form onSubmit={createTaskForm.handleSubmit(onSubmit)}>
            <div className="flex flex-col gap-y-4 bg-red">
              <FormField
                disabled={isPending}
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input className="bg-white text-black" {...field} type="text" placeholder="Enter task name" />
                    </FormControl>
                  ...
                  <FormItem>
                    ...
                    <Select disabled={isPending} defaultValue={field.value} value={field.value} onValueChange={field.onChange}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value={TaskStatus.IN_PROGRESS}>Progress</SelectItem>
                        <SelectItem value={TaskStatus.IN_REVIEW}>Review</SelectItem>
            ...
            <div className="flex items-center justify-between ">
              ...
              <Button className="bg-green-600 text-white" disabled={isPending} type="submit" size="lg">
                Create Task
              </Button>
            </div>
          </form>
