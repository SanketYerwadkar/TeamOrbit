...
export const EditWorkspaceForm = ({ onCancel, initialValues }: EditWorkspaceFormProps) => {
  ...
  return (
    <div className="flex flex-col gap-y-4">
      ...
      <Card className="size-full border-none shadow-none  rounded-2xl bg-white/20 backdrop-blur-lg border border-white/30 shadow-2xl p-6">
            ...
            <form onSubmit={updateWorkspaceForm.handleSubmit(onSubmit)}>
              <div className="flex flex-col gap-y-4">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          className=" rounded-2xl bg-white backdrop-blur-lg border border-white/30 shadow-2xl p-6"
                        />
                      </FormControl>
                ...
                <FormField
                  ...
                  name="image"
                  render={({ field }) => (
                    <div className="flex flex-col gap-y-2  rounded-2xl bg-white backdrop-blur-lg border border-white/30 shadow-2xl p-6">
              ...
              <div className="flex items-center justify-between ">
                ...
                <Button
                  ...
                  type="submit"
                  size="lg"
                  className="bg-green-600  rounded-2xl  border-green-600  shadow-2xl p-6"
                >
                  Save Changes
                </Button>
              </div>
      ...
      <Card className="size-full border-none shadow-none  rounded-2xl bg-white/20 backdrop-blur-lg border border-white/30 shadow-2xl p-6">
        <CardContent className="p-7">
          <div className="flex flex-col">
            ...
            <div className="mt-4">
              <div className="flex items-center gap-x-2  rounded-2xl bg-white backdrop-blur-lg border border-white/30 shadow-2xl p-6">
            ...
            <Button
              ...
              className="ml-auto mt-6 w-fit  rounded-2xl  shadow-2xl p-6"
            >
              Reset invite link
            </Button>
          </div>
      ...
      <Card className="size-full border-none shadow-none  rounded-2xl bg-white/20 backdrop-blur-lg border border-white/30 shadow-2xl p-6">
        <CardContent className="p-7">
          <div className="flex flex-col">
            ...
            <p className="text-sm text-muted-foreground font-bold text-red-600">
            ...
            <Button
              ...
              className="ml-auto mt-6 w-fit bg-red-600"
            >
              Delete Workspace
            </Button>
          </div>
