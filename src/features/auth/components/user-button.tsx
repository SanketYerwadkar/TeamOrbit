...
export const UserButton = () => {
  ...
  return (
    <DropdownMenu modal={false}>
      <DropdownMenuTrigger
        disabled={isPending}
        className="relative  outline-none   rounded-2xl bg-[#2E5077] backdrop-blur-lg border border-white/30 shadow-2xl p-3"
      >
      ...
      <DropdownMenuContent align="end" side="bottom" className="w-60" sideOffset={10}>
        <div className="flex flex-col items-center justify-center gap-2 px-2.5 py-4">
          <Avatar className="size-[70px] border border-neutral-300">
